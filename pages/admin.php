        ...
        <?php
            foreach($habitations as $habit){
                ...
                <div class="habitation">
                    ...
                    <a href="#"><img src="../assets/img/Pictures/<?php echo $habit['idhabitation']; ?>/<?php echo $allpics[0]['nom']; ?>.png" alt="image"></a>
                    </div>
                    <div class="habitation_description">
                        <span><?php echo $habit['loyer'] ?>$ </span>
                        <span><a href="../inc/traitement.php?modif=<?php echo $habit['idhabitation']; ?>">Modifier</a></span>
                        <span><a href="../inc/traitement.php?sup=<?php echo $habit['idhabitation']; ?>">Supprimer</a></span>
                    </div>
                </div>
